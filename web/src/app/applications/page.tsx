                            ...
                            <Table className="min-w-full">
                                <TableHeader>
                                    <TableRow className="border-b bg-muted">
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">JOB TITLE</TableHead>
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">COMPANY</TableHead>
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">LOCATION</TableHead>
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">SALARY</TableHead>
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">STATUS</TableHead>
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">DATE APPLIED</TableHead>
                                        <TableHead className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider whitespace-nowrap">ACTIONS</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                {isLoading ? (
                                    ...
                                    paginatedApplications.map((app) => (
                                        <TableRow key={app.id} className="border-b border-border hover:bg-muted/50 transition-colors">
                                            ...
                                            <TableCell className="px-4 py-4 text-sm">{app.location || 'Not specified'}</TableCell>
                                            <TableCell className="px-4 py-4 text-sm">{app.salary || 'Not specified'}</TableCell>
                                            <TableCell className="px-4 py-4">
                                                <Badge 
                                                    variant="secondary"
