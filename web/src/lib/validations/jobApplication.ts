...
export const jobApplicationSchema = z.object({
  ...
  jobUrl: z
    ...
    .refine((val) => {
      if (!val || val === "") return true;
      try {
        // Use the URL constructor to validate - this accepts all valid URL formats
        new URL(val);
        return true;
      } catch {
        return false;
      }
    }, "Please enter a valid URL (e.g., https://company.com/jobs/position, ftp://files.example.com, mailto:hr@company.com)"),
